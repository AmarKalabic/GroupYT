...
def process_queue():
        try:
            print "try pass"
            #transferreddata = upload_video_to_server.global_result
           # print "This is global_result in START: ", transferreddata
            #chProgressBarMax(transferreddata[1])
            #chProgressBarValue(transferreddata[0])
            msg = queue.get(0)
...
button1 = Button(app, text="START", width=20, command=tb_click) #bilo command start_upload
